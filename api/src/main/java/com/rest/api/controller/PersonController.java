...
public class PersonController {
	...
	public ResponseEntity<PagedModel<EntityModel<PersonVO>>> getPersons(
	...
	@RequestParam (value = "direction", defaultValue = "asc") String direction){
		...
		var sortdirection = "desc".equalsIgnoreCase(direction)
			...
			return ResponseEntity.ok(service.listPerson(pageable));

	}

	@GetMapping(value = "/listbyname/{firstName}", produces = {MD_Type.APPLICATION_JSON, MD_Type.APPLICATION_XML, MD_Type.APPLICATION_YML})
	@Operation( summary = "Get all person by name",
			description = "Find all persons By Name",
			tags = {"People"},
			responses = {
					@ApiResponse( description = "Get persons Sucess", responseCode = "200",
							content = @Content(schema = @Schema(implementation = PersonVO.class))
	...
	public ResponseEntity<PagedModel<EntityModel<PersonVO>>> findPersonsByName(
			@PathVariable(value="firstName") String firstaName,
			@RequestParam(value = "page", defaultValue = "0")Integer page,
			@RequestParam (value = "limit", defaultValue = "12") Integer limit,
			@RequestParam (value = "direction", defaultValue = "asc") String direction){
		...
		return ResponseEntity.ok(service.findPersonsByName(firstaName,pageable));
