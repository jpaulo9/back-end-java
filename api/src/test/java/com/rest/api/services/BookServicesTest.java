...
class BookServicesTest {
	...
	void testCreateWithNullBook() {
		Exception exception = assertThrows(RequireIsNullException.class, () -> {
	...
	void testUpdate() {
		...
		var result = service.editBook(vo);
