...
import com.rest.api.integrationtests.vo.PersonVO;
...
public class DozerConverterTest {
    ...
    public void parseEntityListToVOListTest() {
        List<PersonVO> outputList = DozerMapper.ListParseObject(inputObject.mockEntityList(), PersonVO.class);
    ...
    public void parserVOListToEntityListTest() {
        List<Person> outputList = DozerMapper.ListParseObject(inputObject.mockVOList(), Person.class);
